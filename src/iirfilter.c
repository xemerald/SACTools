...
static int beroots( const int, _Complex double *, int *, double * );
static int buroots( const int, _Complex double *, int *, double * );
static int cutoff( double, IIR_FILTER * );
static double warp( const double, const double );

static int lowpass( const _Complex double *, const _Complex double *, const int *, const double, IIR_FILTER * );
static int highpass( const _Complex double *, const _Complex double *, const int *, const double, IIR_FILTER * );
static int bandpass( const _Complex double *, const _Complex double *, const int *, const double, const double, const double, IIR_FILTER * );
static int bandreject( const _Complex double *, const _Complex double *, const int *, const double, const double, const double, IIR_FILTER * );
 ...
 * @return double
 */
double applyfilter( const double sample, const IIR_FILTER *filter, IIR_STAGE *stage )
{
	int    i;
	double output = 0;
	double b0, b1, b2;
 ...
 * @return IIR_FILTER
 */
IIR_FILTER designfilter( const int order, const int filtertype, const int anproto, const double freql, const double freqh, const double delta )
{
	int             stype[MAX_NUM_SECTIONS];
	_Complex double poles[MAX_NUM_SECTIONS];
	_Complex double zeros[MAX_NUM_SECTIONS];
 ...
 * @return int
 */
static int beroots( const int order, _Complex double *poles, int *rtype, double *dcvalue )
{
	int nsects;
 ...
 * @return int
 */
static int buroots( const int order, _Complex double *poles, int *rtype, double *dcvalue )
{
	int i;
	int nsects = 0;
...
{
	double result = PI2*freq*delta / 2.0;
 ...
 * @return int
 */
static int lowpass( const _Complex double *poles, const _Complex double *zeros, const int *rtype, const double dcvalue, IIR_FILTER *filter )
{
	int    i;
	double scale;
	double tmppole;
 ...
 * @return int
 */
static int highpass( const _Complex double *poles, const _Complex double *zeros, const int *rtype, const double dcvalue, IIR_FILTER *filter )
{
	int    i;
	double scale;
	double tmppole;
 ...
 */
static int bandpass(
	const _Complex double *poles, const _Complex double *zeros, const int *rtype,
	const double dcvalue, const double freql, const double freqh, IIR_FILTER *filter
) {
